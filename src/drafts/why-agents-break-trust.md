...
These are not theoretical attack vectors. Sardine documents seven agentic attack types currently producing losses across banking, fintech, and crypto networks.[^sardine] Three illustrate the qualitative shift from human-speed to agent-speed attacks:
