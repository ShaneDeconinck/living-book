...
[^galileo-cascade]: Galileo AI, "Detect and Prevent Malicious Agents in Multi-Agent Systems" and "Why Multi-Agent AI Systems Fail and How to Fix Them," galileo.ai, 2025-2026. In simulated multi-agent systems, a single compromised agent poisoned 87% of downstream decision-making within 4 hours through memory poisoning and shared state corruption.
