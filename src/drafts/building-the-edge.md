...
The seventeen technical chapters compose into a coherent trust infrastructure stack, organized around the three PAC pillars:

**Control (the foundation):** Trust infrastructure starts with what you can enforce. [Agent Identity and Delegation](agent-identity.md) establishes who agents are and what authority they carry. [Sandboxing and Execution Security](execution-security.md) contains what agents can do at the system level. [Cross-Organization Trust](cross-org-trust.md) extends enforcement across organizational boundaries. [Agent Communication Protocols](agent-communication.md) handle how agents discover and interact with tools and each other. [Supply Chain Security](supply-chain-security.md) verifies the components inside the agent. [Tool Security and MCP Poisoning](tool-security.md) addresses the attack surface where agents meet external tools. [Cryptographic Authorization Governance](cryptographic-authorization.md) provides the "prove" alternative to "can't" and "don't."

**Accountability (the connective tissue):** Control without accountability is enforcement without evidence. The [Regulatory Landscape](regulatory-landscape.md) maps the compliance requirements converging from the EU AI Act, NIST, and ISO 42001. [Shadow Agent Governance](shadow-agent-governance.md) discovers and registers the agents already running. [Multi-Agent Trust and Orchestration](multi-agent-trust.md) traces delegation chains and prevents cascading failures. [Agent Accountability at Scale](accountability-at-scale.md) addresses what happens when thousands of agents need governing simultaneously. [Agent Observability](agent-observability.md) separates the five layers of agent visibility that most deployments conflate. [Agent Incident Response](agent-incident-response.md) covers what to do when agent failures occur.

**Potential (the driver):** Infrastructure without value is overhead. [Context Infrastructure](context-infrastructure.md) ensures agents have the right information at the right time. [Reliability and Evaluation](reliability-evaluation.md) measures whether agents actually work. [Agent Payments and Economics](agent-payments.md) enables the economic layer. [Human-Agent Collaboration](human-agent-collaboration.md) designs the oversight model that makes deployment possible.

The [opening chapter](why-agents-break-trust.md) and the [PAC Framework chapter](pac-framework.md) are the spine: they explain why this infrastructure is needed and how to reason about it.
...
**They redesign processes, not just automate them.** Layering agents onto existing workflows preserves the workflow's limitations. The organizations getting value are asking: if we were designing this process today, knowing agents could handle the predictable parts, what would we build? Shane's observation: the work is not disappearing, it is changing shape.[^15] The human role that lasts is at the root of the intent: defining what should happen, making the calls that require judgment, owning the decisions an agent cannot.
...
[^10]: Yuxin Huang et al., ["On the Resilience of LLM-Based Multi-Agent Collaboration with Faulty Agents"](https://arxiv.org/abs/2408.00989), ICML 2025.
...
[^crowdstrike-rsac]: CrowdStrike, RSAC 2026, crowdstrike.com/events/rsac. George Kurtz keynote, March 24. CrowdStrike, "AI Operational Reality Manifesto," crowdstrike.com, 2026.
[^rsac-sandbox]: RSAC, "Finalists Announced for RSAC Innovation Sandbox Contest 2026," prnewswire.com, February 2026. Full finalist list: Charm Security, Clearly AI, Crash Override, Fig Security, Geordie AI, Glide Identity, Humanix, Realm Labs, Token Security, ZeroPath. Each finalist receives a $5 million investment. Past finalists include over 100 acquisitions and $18.1 billion in total funding.
[^token-sc-awards]: Token Security, "Token Security Named Finalist in Two Categories of the 2026 SC Awards," globenewswire.com, March 4, 2026. Categories: Most Promising Early-Stage Startup and Best Emerging Technology.
...
[^codex-security-edge]: OpenAI, "Codex Security: now in research preview," openai.com, March 6, 2026. During beta testing in the 30 days prior to public launch, scanned 1.2 million commits across external repositories. 792 critical findings, 10,561 high-severity findings across OpenSSH, GnuTLS, PHP, Chromium, and other open-source projects.
...
[^kiro-edge]: Financial Times, reported February 20, 2026; Amazon response at aboutamazon.com, February 20, 2026. Amazon Kiro deleted a production AWS Cost Explorer environment, causing a 13-hour outage. The agent inherited the deploying engineer's elevated permissions, bypassing the two-person approval policy.
...
[^forrester-trust]: Forrester, "Bot Management Graduates: Introducing the Bot and Agent Trust Management Market," forrester.com, Q4 2025. Category rename from "Bot Management" to "Bot and Agent Trust Management." See also "The Bot And Agent Trust Management Software Landscape, Q4 2025."
[^gartner-guardian-edge]: Gartner, "Market Guide for Guardian Agents," Avivah Litan and Daryl Plummer, February 25, 2026. First Gartner market guide defining agent governance as a standalone enterprise category. Representative vendors include PlainID, NeuralTrust, Wayfound, Holistic AI, and Opsin.
[^panw-cyberark]: Palo Alto Networks, "Palo Alto Networks Completes Acquisition of CyberArk to Secure the AI Era," paloaltonetworks.com, February 11, 2026. $25 billion transaction, one of the largest in security industry history. CyberArk shareholders received $45.00 cash and 2.2005 shares of Palo Alto Networks common stock per share. See also CSO Online, "Palo Alto closes privileged access gap with $25B CyberArk acquisition," February 2026.
