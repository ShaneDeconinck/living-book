...
**Control (the foundation):** Trust infrastructure starts with what you can enforce. [Agent Identity and Delegation](agent-identity.md) establishes who agents are and what authority they carry. [Sandboxing and Execution Security](execution-security.md) contains what agents can do at the system level. [Cross-Organization Trust](cross-org-trust.md) extends enforcement across organizational boundaries. [Agent Communication Protocols](agent-communication.md) handle how agents discover and interact with tools and each other. [Supply Chain Security](supply-chain-security.md) verifies the components inside the agent.

**Accountability (the connective tissue):** Control without accountability is enforcement without evidence. The [Regulatory Landscape](regulatory-landscape.md) maps the compliance requirements converging from the EU AI Act, NIST, and ISO 42001. [Shadow Agent Governance](shadow-agent-governance.md) discovers and registers the agents already running. [Multi-Agent Trust and Orchestration](multi-agent-trust.md) traces delegation chains and prevents cascading failures. Each creates the audit trail that makes control provable.
...
[^crowdstrike-rsac]: CrowdStrike, RSAC 2026, crowdstrike.com/events/rsac. George Kurtz keynote, March 24: "By 2027, your smartest employee will be a machine. Most organizations deploy AI agents with less governance than they'd give an intern."
