...
[^openai-atlas]: OpenAI, "Continuously hardening ChatGPT Atlas against prompt injection attacks," December 2025, openai.com. RL-powered automated red teaming: an automated attacker generates candidate injections and tests them in simulation, with discoveries feeding adversarial training of the Atlas model. Defense is adversarial training, not inference-time detection.
