...
The five-layer stack does not answer "why did the agent decide this?"
...
- Use inference-time monitoring (not only post-hoc logging) for agents where intervention before action is feasible, particularly high blast-radius decisions.
