...
[^nguyen-mas-threats]: Tam Nguyen et al., "Security Considerations for Multi-agent Systems," arXiv:2603.09002, March 9, 2026. Taxonomy of 193 agentic AI threats across 9 categories. First empirical cross-framework comparison for multi-agent system security. 16 frameworks evaluated; OWASP Agentic Security Initiative leads at 65.3% coverage. Non-determinism (1.231/5) and data leakage (1.340/5) are the most under-addressed threat domains.
