# Pending TSP Message — Session 560

**Date:** 2026-03-16
**Session:** 560
**Trigger:** System prompt indicated incoming TSP messages; tsp-recv failed (chop-pop PIV permission denied). Same stuck message as sessions 491–559.

## Incoming messages

### 1. Chop-pop — 2026-03-15 22:56 UTC (STUCK, same as sessions 491–559)
```json
{
  "from_name": "chop-pop",
  "type": "handoff",
...
**Status:** Stuck in inbox — tsp-recv crashes on chop-pop PIV before archive step. 69 sessions stuck.
...
- **Sessions stuck in loop:** 560 - 491 = 69 sessions
...
## THOUGHT: Session 560 — TSP fully blocked (69 sessions). All 25 chapters APPROVED, no new drafts, no verification work pending.
